...
/* For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1
 * For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1
 * For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1
 * For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1
 * For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1 For UART1
...
void Init_UART1(Uint32 baud_rate)
///////////////////////////////////////////////////////////////////////
// Purpose:   Configures UART1 to operate at the specified baud rate
//
// Input:     baud_rate - desired baud rate
//
// Returns:   Nothing
...
///////////////////////////////////////////////////////////////////////
{
    Uint32 divisor;
    volatile Uint8 dummy;
    UART* pUART1 =  UART1_Base;

    // divisor is UART_CLOCK/(baud_rate * 16) (16x oversampling)
    // divisor is rounded by adding baud_rate*8 before division
    divisor = (UART_CLOCK + (baud_rate << 3)) / (baud_rate << 4);

    pUART1->pwremu_mgmt = 0;                // reset UART
    wait(500);

    pUART1->dll = (divisor & 0xff);         // baud rate divisor
    pUART1->dlh = (divisor >> 8);
    pUART1->iir_fcr = 0x0000;               // disable FIFOs
    pUART1->ier = 0x0000;                   // disable interrupts
    pUART1->lcr = 0x0003;                   // 8-N-1
    pUART1->mcr = 0x0000;                   // no flow control, no loopback
    pUART1->mdr = 0;                        // use 16x oversampling

    pUART1->pwremu_mgmt = 0x6001;           // tx/rx enabled

    dummy = pUART1->rbr_thr;                // flush rx data
}

void Write_UART1(Uint8 c)
///////////////////////////////////////////////////////////////////////
// Purpose:   Writes a byte to the UART1 transmitter
//
// Input:     c - 8-bit data to write
//
// Returns:   Nothing
...
///////////////////////////////////////////////////////////////////////
// Purpose:   Writes a null-terminated string to the UART1 transmitter
//
// Input:     s - pointer to string
//
// Returns:   Nothing
//
// Calls:     IsTxReady_UART1, Write_UART1
//
// Notes:     None
///////////////////////////////////////////////////////////////////////
{
    while(*s) {                             // loop until null terminator
        while(!IsTxReady_UART1())           // wait for transmitter to be ready
            ;
        Write_UART1(*s++);                  // send next charactor
    }
}

Uint8 Read_UART1()
///////////////////////////////////////////////////////////////////////
// Purpose:   Reads a byte to the UART1 receiver
//
// Input:     None
//
// Returns:   Data read
...
///////////////////////////////////////////////////////////////////////
{
    ...
    return pUART1->rbr_thr;
}

Uint8 IsDataReady_UART1()
///////////////////////////////////////////////////////////////////////
// Purpose:   Checks if the UART1 receiver has data available
//
// Input:     None
//
// Returns:   Non-zero if data is ready
...
///////////////////////////////////////////////////////////////////////
{
    ...
    return pUART1->lsr & UART_LSR_DR;
}

Uint8 IsTxReady_UART1()
///////////////////////////////////////////////////////////////////////
// Purpose:   Checks if the UART1 transmitter is ready for more data
//
// Input:     None
//
// Returns:   Non-zero if transmitter is ready for data
...
///////////////////////////////////////////////////////////////////////
{
    ...
    return pUART1->lsr & UART_LSR_THRE;
}




/*For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0
 * For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0
 * For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0
 * For UART0 For UART0 For UART0 For UART0 For UART0For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0
 * For UART0 For UART0 For UART0 For UART0 For UART0For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0
 * For UART0 For UART0 For UART0 For UART0 For UART0For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0
 * For UART0 For UART0 For UART0 For UART0 For UART0For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0
 * For UART0 For UART0 For UART0 For UART0 For UART0For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0 For UART0
...
void Init_UART0(Uint32 baud_rate)
///////////////////////////////////////////////////////////////////////
// Purpose:   Configures UART0 to operate at the specified baud rate
//
// Input:     baud_rate - desired baud rate
//
// Returns:   Nothing
...
///////////////////////////////////////////////////////////////////////
{
    Uint32 divisor;
    volatile Uint8 dummy;
    UART* pUART0 =  UART0_Base;

    // divisor is UART_CLOCK/(baud_rate * 16) (16x oversampling)
    // divisor is rounded by adding baud_rate*8 before division
    divisor = (UART_CLOCK + (baud_rate << 3)) / (baud_rate << 4);

    pUART0->pwremu_mgmt = 0;                // reset UART
    wait(500);

    pUART0->dll = (divisor & 0xff);         // baud rate divisor
    pUART0->dlh = (divisor >> 8);
    pUART0->iir_fcr = 0x0000;               // disable FIFOs
    pUART0->ier = 0x0000;                   // disable interrupts
    pUART0->lcr = 0x0003;                   // 8-N-1
    pUART0->mcr = 0x0000;                   // no flow control, no loopback
    pUART0->mdr = 0;                        // use 16x oversampling

    pUART0->pwremu_mgmt = 0x6001;           // tx/rx enabled

    dummy = pUART0->rbr_thr;                // flush rx data
}

void Write_UART0(Uint8 c)
///////////////////////////////////////////////////////////////////////
// Purpose:   Writes a byte to the UART0 transmitter
//
// Input:     c - 8-bit data to write
//
// Returns:   Nothing
...
void Puts_UART0(char *s)
///////////////////////////////////////////////////////////////////////
// Purpose:   Writes a null-terminated string to the UART0 transmitter
//
// Input:     s - pointer to string
//
// Returns:   Nothing
//
// Calls:     IsTxReady_UART0, Write_UART0
//
// Notes:     None
///////////////////////////////////////////////////////////////////////
{
    while(*s) {                             // loop until null terminator
        while(!IsTxReady_UART0())           // wait for transmitter to be ready
            ;
        Write_UART0(*s++);                  // send next charactor
    }
}

Uint8 Read_UART0()
///////////////////////////////////////////////////////////////////////
// Purpose:   Reads a byte to the UART0 receiver
//
// Input:     None
//
// Returns:   Data read
...
///////////////////////////////////////////////////////////////////////
{
    ...
    return pUART0->rbr_thr;
}

Uint8 IsDataReady_UART0()
///////////////////////////////////////////////////////////////////////
// Purpose:   Checks if the UART0 receiver has data available
//
// Input:     None
//
// Returns:   Non-zero if data is ready
...
///////////////////////////////////////////////////////////////////////
{
    ...
    return pUART0->lsr & UART_LSR_DR;
}

Uint8 IsTxReady_UART0()
///////////////////////////////////////////////////////////////////////
// Purpose:   Checks if the UART0 transmitter is ready for more data
//
// Input:     None
//
// Returns:   Non-zero if transmitter is ready for data
...
///////////////////////////////////////////////////////////////////////
{
    ...
    return pUART0->lsr & UART_LSR_THRE;
}
